...
export const Categorie_Api = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getFilterAllCategorie: builder.query<any, void>({
      query: () => {
        return {
          url: "v2/categorie/categorie-urls",
          method: "GET",
        };
      },
      providesTags: [{ type: "Categorie", id: "LIST" }],
...
export const { useGetSingleQuery,useGetFilterAllCategorieQuery, useGetAllCategorieQuery } = Categorie_Api;
